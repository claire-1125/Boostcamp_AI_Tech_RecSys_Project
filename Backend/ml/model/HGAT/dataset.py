...
class recipe_dataset(Dataset):
    def __init__(self, train, test, recipe_ingredient, u_dim):
        ...
        self.ingredients = np.load(cur_path + '/recipe_Data/ingredient_emb/ing_seq.npy')
        ...
        self.recipe_embedding = nn.Embedding.from_pretrained(torch.load(cur_path + '/recipe_Data/sentence_emb/sentence_5900_emb_multilingual-cased-v1.pt').squeeze(1))
        self.ing_embedding = nn.Embedding.from_pretrained(torch.load(cur_path + '/recipe_Data/ingredient_emb/ing_emb.pt').squeeze(1))
    ...
    def get_matrix(self):        
        ...
        # 레시피_레시피        
        r_r_cos = torch.load(cur_path + '/recipe_Data/sentence_emb/sentence_5900_cos_multilingual-cased-v1.pt')
